...
if(isset($_SESSION["Admin"]))
{
    ...
    if(isset($_POST["DanhMucId"])&&isset($_POST["Name"])&&isset($_POST["MaChuyenBay"])&&isset($_POST["DiemDi"])&&isset($_POST["DiemDen"])&&isset($_POST["NgayDi"])&&isset($_POST["Gia"])&&isset($_POST["Img"])&&isset($_POST["Img_hang"])&&isset($_POST["NoiDung"])&&isset($_POST["Title"])&&isset($_POST["Keyword"])&&isset($_POST["Description"])&&isset($_POST["Created"]))
    {
       $array=$_POST;
       if(!isset($array['Id']))
       $array['Id']='0';
