...
if(isset($_SESSION["Admin"]))
{
    ...
    if(isset($_POST["NoiBat"])&&isset($_POST["Name"])&&isset($_POST["Img"])&&isset($_POST["NoiDung"])&&isset($_POST["Title"])&&isset($_POST["Keyword"])&&isset($_POST["Description"])&&isset($_POST["Created"]))
    {
       $array=$_POST;
       if(!isset($array['Id']))
       $array['Id']='0';
