...
<!-- <script type="text/javascript">
    $(document).ready(function (e) {
        ...
        {
            $deferered.push(search_noidia('{SITE-NAME}/controller/default/timkiem_aj', {data_post}, "VietJetAir,JetStar,VietnamAirlines,Abacus", "", "Price", "result_html"));
        }
        $start = Date.now();
    });
</script> -->
                    ...
                    <!--<script>
                        $(document).ready(function () {
                            ...
                            $("#thoigian_sx").click(function () {
                                ...
                                $deferered = Array();
                                $deferered.push(search_noidia('{SITE-NAME}/controller/default/timkiem_aj', {data_post}, "VietJetAir,JetStar,VietnamAirlines,Abacus", "", DepartTime, "result_html"));
                            })

                            $("#hang_sx").click(function () {
                                var Hang = "1";
                                $deferered = Array();
                                $deferered.push(search_noidia('{SITE-NAME}/controller/default/timkiem_aj', {data_post}, "VietJetAir,JetStar,VietnamAirlines,Abacus", "", Hang, "result_html"));
                            })
                        ...
                        $(function () {
                            ...
                            $("#slider-range").slider({
                                change: function (event, ui) {
                                    ...
                                    $deferered = Array();
                                    $deferered.push(search_noidia('{SITE-NAME}/controller/default/timkiem_aj2', {data_post}, "VietJetAir,JetStar,VietnamAirlines,Abacus", "", amu, "result_html"));  //time-0-17
