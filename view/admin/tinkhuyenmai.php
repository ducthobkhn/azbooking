...
{
    return '<th>Id</th><th>NoiBat</th><th>Tên</th><th>Img</th>';
}
//
...
{
    $str_from='';
    $str_from.='<p><label>NoiBat</label><input class="text-input small-input" type="text"  name="NoiBat" value="'.(($form!=false)?$form->NoiBat:'').'" /></p>';
