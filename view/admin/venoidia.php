...
{
    return '<th>Id</th><th>DanhMucId</th><th>Tên</th><th>MaChuyenBay</th><th>DiemDi</th><th>DiemDen</th><th>NgayDi</th><th>Gia</th><th>Img</th><th>Img_hang</th><th>Created</th>';
}
//
function showTableBody($data)
{
    ...
    if(count($data)>0) foreach($data as $obj)
    {
        ...
        $TableBody.="<td>".$obj->MaChuyenBay."</td>";
        $TableBody.="<td>".$obj->DiemDi."</td>";
        $TableBody.="<td>".$obj->DiemDen."</td>";
        $TableBody.="<td>".$obj->NgayDi."</td>";
        $TableBody.="<td>".$obj->Gia."</td>";
